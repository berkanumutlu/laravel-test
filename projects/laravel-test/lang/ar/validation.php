...
return [
    ...
    */
    ...
    'accepted'             => 'تم قبول ال:attribute.',
    'accepted_if'          => 'يجب قبول ال:attribute عندما :other تكون :value.',
    ...
    'ascii'                => 'يجب أن يحتوي حقل :attribute على أحرف أبجدية رقمية أحادية البايت ورموزًا.',
    ...
    'date_format'          => 'لا يتطابق تنسيق حقل :attribute مع :format.',
    'decimal'              => 'يجب أن يحتوي حقل :attribute على :decimal مكان عشري.',
    'declined'             => 'يجب رفض ال:attribute.',
    'declined_if'          => 'يجب رفض ال:attribute عندما :other يكون :value.',
    ...
    'enum'                 => 'تم اختيار :attribute المحدد غير صالح.',
    'exists'               => 'القيمة المحددة :attribute غير صالحة.',
    'extensions'           => 'يجب أن يحتوي حقل :attribute على ملف بأحد الامتدادات التالية: :values.',
    ...
    'hex_color'            => 'يجب أن يكون حقل :attribute بصيغة لون هكس.',
    ...
    'password'             => [
        ...
        'mixed'         => 'يجب أن يحتوي حقل :attribute على أحرف كبيرة وصغيرة وأرقام ورموز.',
        'numbers'       => 'يجب أن يحتوي حقل :attribute على رقم واحد على الأقل.',
        'symbols'       => 'يجب أن يحتوي حقل :attribute على رمز واحد على الأقل.',
        'uncompromised' => 'ال:attribute الذي تم إدخاله تم الكشف عنه في تسرب بيانات. يرجى اختيار :attribute آخر.',
    ],
    ...
    'present_with_all'     => 'يجب أن يكون حقل :attribute موجودًا عندما تكون كل :values موجودة.',
    ...
    'required_array_keys'  => 'مطلوبة مفاتيح ال:attribute.',
    ...
    */
    ...
    'email.exists'  => "البريد الالكتروني او كلمة المرور غير صحيحة.",
    'required_text' => "مطلوب",
];
